...
- [X] T001 Run `npm install`, `npm run lint`, `npm run typecheck`, and `npm test` from repo root and confirm all four pass on the current branch (`008-tag-management`) before any source edits
